...
export const useInitializeAgora = () => {
  ...
  const token =
    '0067a570232bfbd4725a7253e76cf8eb678IADKK8ChTda0JxunGtTTS6+4hNgrkQ980SfEdrYmzlQ+KU7rHXcAAAAAEABwjq6PxC4kYAEAAQDCLiRg';

  const [channelName, setChannelName] = useState('Doctor Suu');
